...
await conn.groupSettingUpdate(from, 'announcement')
 await conn.sendMessage(from , { text: `*ɢʀᴏᴜᴘ ᴄʜᴀᴛ ᴄʟᴏꜱᴇᴅ ʙʏ ᴀᴅᴍɪɴ ${pushname}* 🔇` }, { quoted: mek } )
} catch (e) {
...
await conn.groupSettingUpdate(from, 'not_announcement')
 await conn.sendMessage(from , { text: `*ɢʀᴏᴜᴘ ᴄʜᴀᴛ ᴏᴘᴇɴ ʙʏ ᴀᴅᴍɪɴ ${pushname}* 🔊` }, { quoted: mek } )
} catch (e) {
await conn.sendMessage(from, { react: { text: '❌', key: mek.key } })
console.log(e)
reply(`❌ *Error Accurated !!*\n\n${e}`)
...
if (!isAdmins) { if (!isDev) return reply(msr.you_adm) }
 await conn.sendMessage(from , { text: `*ɢᴏᴏᴅʙʏᴇ ᴀʟʟ* 👋🏻` }, { quoted: mek } )
...
if (!isAdmins) { if (!isDev) return reply(msr.you_adm),{quoted:mek }} 
if (!isBotAdmins) return reply(msr.give_adm)
if (!q) return reply("*ᴘʟᴇᴀꜱᴇ ᴡʀɪᴛᴇ ᴛʜᴇ ɴᴇᴡ ɢʀᴏᴜᴘ ᴅᴇꜱᴄʀɪᴘᴛɪᴏɴ* 🖊️")
await conn.groupUpdateDescription(from, q )
 await conn.sendMessage(from , { text: `✅  *ɢʀᴏᴜᴘ ᴅᴇꜱᴄʀɪᴘᴛɪᴏɴ ᴜᴘᴅᴀᴛᴇᴅ*` }, { quoted: mek } )
} catch (e) {
await conn.sendMessage(from, { react: { text: '❌', key: mek.key } })
console.log(e)
reply(`❌ *Error Accurated !!*\n\n${e}`)
...
if (!q) return reply("*Please write the Group Link*️ 🖇️")
 ...
 await conn.groupAcceptInvite(result)
     await conn.sendMessage(from , { text: `✅ *ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴊᴏɪɴᴇᴅ*`}, { quoted: mek } )
} catch (e) {
await conn.sendMessage(from, { react: { text: '❌', key: mek.key } })
console.log(e)
reply(`❌ *Error Accurated !!*\n\n${e}`)
...
const code = await conn.groupInviteCode(from)
 ...
 await conn.sendMessage(from , { text: `🖇️ *ɢʀᴏᴜᴘ ʟɪɴᴋ*\n\nhttps://chat.whatsapp.com/${code}`}, { quoted: mek } )
} catch (e) {
await conn.sendMessage(from, { react: { text: '❌', key: mek.key } })
console.log(e)
reply(`❌ *Error Accurated !!*\n\n${e}`)
...
await conn.groupRevokeInvite(from)
 await conn.sendMessage(from , { text: `*ɢʀᴏᴜᴘ ʟɪɴᴋ ʀᴇꜱᴇᴛᴇᴅ* ⛔`}, { quoted: mek } )
} catch (e) {
await conn.sendMessage(from, { react: { text: '❌', key: mek.key } })
console.log(e)
reply(`❌ *Error Accurated !!*\n\n${e}`)
...
if (!isBotAdmins) return reply(msr.give_adm)
		...
		let users = mek.mentionedJid ? mek.mentionedJid[0] : mek.msg.contextInfo.participant || false;
			...
			await conn.sendMessage(from,{text:`*ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ʀᴇᴍᴏᴠᴇᴅ*  ✅`},{quoted:mek })
...
if (!isBotAdmins) return reply(msr.give_adm)   
	...
	if (!users) return reply("*Couldn't find any user in context* ❌")
		...
		if  ( groupAdmins.includes(users)) return reply('❗ *ᴜꜱᴇʀ ᴀʟʀᴇᴀᴅʏ ᴀɴ ᴀᴅᴍɪɴ*  ✅')
		    await conn.groupParticipantsUpdate(from, [users], "promote")
			await conn.sendMessage(from,{text:`*ᴜꜱᴇʀ ᴘʀᴏᴍᴇᴛᴇᴅ ᴀꜱ ᴀᴅᴍɪɴ*  ✅`},{quoted:mek })
...
if (!isBotAdmins) return reply(msr.give_adm)
		...
		let teks = `*😇 ʜɪ ᴀʟʟ ᴘʟᴇᴀꜱᴇ ɢɪᴠᴇ ᴍᴇ ᴀ ᴀᴛᴛᴇɴᴛɪᴏɴ* 
...
*ɢʀᴏᴜᴘ ᴅᴇꜱᴄʀɪᴘᴛɪᴏɴ* : ${metadata.desc?.toString() || 'undefined'}
